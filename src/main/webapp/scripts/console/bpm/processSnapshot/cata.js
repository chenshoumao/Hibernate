...
var _deptSetting = {
	...
	callback : {
		...
		onClick : function(event, treeId, treeNode) {
			...
			var id = treeNode.id;
			if (id == "0") {
				document.getElementById("iframe_processmeta").src =  $("#basePath").val()+"/console/bpm/processmeta/snapshot.xsp";
			} else {
				document.getElementById("iframe_processmeta").src =  $("#basePath").val()+"/console/bpm/processmeta/snapshot.xsp?workflowCataId="
						+ id;
			}
		}
	}
