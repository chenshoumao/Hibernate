/**
 * 这个js与index.js的功能基本一致，只是多了权限的控制
 */
...
var treeSetting = {
	...
	callback : {
		...
		onClick : function(event, treeId, treeNode) {
			...
			var url='';
			if (id == "0") {
				url=$("#basePath").val()+"/console/systemMeta/getOwnerSystemMetas.xsp";
				document.getElementById("iframe_systemMeta").src = encodeURI(url) ;
			} else {
				url=$("#basePath").val()+"/console/systemMeta/getOwnerSystemMetas.xsp?metaCataId="+ id+"&cataName="+name;
				document.getElementById("iframe_systemMeta").src =  encodeURI(url);
			}
		}
	}
