...
*/
    ...
    $("#btnsave").click(function() {
        ...
        if ($.trim(formName)=="") {
           ...
           // var formContentEditor=ace.edit("formContentEditor");
            ...
            formDef.postOpenEventCls=$("#postOpenEventCls").textbox('getValue');
            ...
            formDef.isRefCss=$("[name=isRefCss]:checked").val();
            formDef.formTheme=$("#formTheme").combobox("getValue");
    ...
    $("#RefCssOff").click(function() {
    	$("#formTheme").combobox({
    		disabled:true
    	});
    	$("#formTheme").combobox("setValue", "none");
    });
    
    $("#RefCssOn").click(function() {
    	$("#formTheme").combobox({
    		disabled:false
    	});
    	$("#formTheme").combobox("setValue", "bootstrap2");
    });
});
