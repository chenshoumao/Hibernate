...
b){e.push(ol.proj.transform(b,c,"EPSG:4326"))});"function"===typeof window.onSelectSeachart&&((b=map.getLayer("_highlight_"))&&b.getSource().clear(),window.onSelectSeachart({id:a.getId(),coords:e},d))}})}var c=new ol.Sphere(6378137);app.MapDraw=function(c){this.tooltipOverlays=[];this.features=new ol.Collection;this.source=new ol.source.Vector({features:this.features,wrapX:!1});this.vectorlayer=new ol.layer.Vector({source:this.source,style:function(b){return a(b,{color:"#ffcc33",width:4,image:"styles/gis/images/arrow-y.png"})}});
...
b("\u56fe\u5c42\u7ba1\u7406","<img src='styles/gis/images/layers.png'>",function(i){
	function a(a,b){
		var d=a.get("name");
