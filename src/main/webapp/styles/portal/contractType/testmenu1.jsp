...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
 ...
 <link href="/menusystem/images/LOGO.ico" rel="shortcut icon" type="image/x-icon" />
<link href="/menusystem/styles/common.css" rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" href="/menusystem/scripts/jquery/easyui/themes/default/easyui.css"> 
<link rel="stylesheet" type="text/css" href="/menusystem/styles/frameset.css">
<link rel="stylesheet" type="text/css" href="/menusystem/styles/treeicon/icon.css">
<link rel="stylesheet" type="text/css" href="/menusystem/scripts/jquery/easyui/themes/icon.css">
<link rel="stylesheet" type="text/css" href="/menusystem/scripts/webuploader-0.1.5/webuploader.css">

<script type="text/javascript" src="/menusystem/scripts/jquery/jquery-1.11.1.min.js"></script>

<script type="text/javascript" src="/menusystem/scripts/json2.js"></script>

<script type="text/javascript" src="/menusystem/scripts/jquery/easyui/jquery.easyui.min.js"></script>
<script type="text/javascript" src="/menusystem/scripts/jquery/easyui/locale/easyui-lang-zh_CN.js"></script>
<script type="text/javascript" src="/menusystem/scripts/frameset.js"></script>
<script type="text/javascript" src="/menusystem/scripts/comonfn.js"></script>
<script type="text/javascript" src="/menusystem/scripts/extprotype.js"></script>
<script type="text/javascript" src="/menusystem/scripts/webuploader-0.1.5/webuploader.js"></script>
<script type="text/javascript" src="/menusystem/scripts/ajaxRebuild.js"></script>
...
$(function(){
	...
	$('#dg').treegrid({
		...
		title : '',
		url : basePath+'/console/menu/item/testshows.action',
		 height: "100%",
	method : 'POST',
		striped : true,
		nowrap : true,
...
//TODO 初始化加载结束
        ...
        function newMenuItem(){
            ...
            $("#update_time").textbox('setValue',date);
            $("#create_time").textbox('setValue',date);
            $("#update_by").textbox('setValue',"lds");
            $("#create_by").textbox('setValue',"lds");
        ...
        function  showParentMenuItem(){
    	   ...
    	   var basePath = location[0]+'//'+location[2]+'/'+location[3]; 
         	$('#parentMenuItemTreee').tree({   
                url: basePath+'/console/menu/item/menuItemTree2.action?id=0',   
                loadMsg: "数据加载中，请稍后...",  	
	...
	<div id="dlg" class="easyui-dialog"
		...
		<div id="tabs" class="easyui-tabs" fit="true" border="false">
				...
				<form id="fm" method="post" novalidate>
					...
					<div class="fitem">
						<label>上级菜单:</label> <input id="parentItemId" name="parentItemId"
							type="hidden" value="22" /> <input class="easyui-textbox"
			...
			<!-- 	<select  name="itemType" id="itemType" class="easyui-combobox" style="width: 280px;">
				...
				<select     id="itemType"  class="easyui-combobox"  style="width: 280px;"  name="itemType"   > <option     value='1'>后台</option><option     value='2'>前端</option></select>
