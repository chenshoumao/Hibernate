...
<link rel="stylesheet" type="text/css"href="<%=basePath%>styles/frameset.css">
<link rel="stylesheet" type="text/css"href="<%=basePath%>styles/treeicon/icon.css">
<link rel="stylesheet" type="text/css"href="<%=basePath %>scripts/jquery/easyui/themes/icon.css">

<script type="text/javascript"src="<%=basePath%>scripts/jquery/jquery-1.11.1.min.js"></script>
...
<script type="text/javascript"src="<%=basePath%>scripts/frameset.js"></script>
